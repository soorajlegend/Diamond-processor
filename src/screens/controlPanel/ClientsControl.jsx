...
function ClientControl() {
    ...
    // } else {
        ...
        const data = [
            { id: 1, title: "hello", desc: "By using render prop you can pass a function as a component and also share props from parent itself" },
            { id: 2, title: "hello", desc: "By using render prop you can pass a function as a component and also share props from parent itself" },
            { id: 3, title: "hello", desc: "By using render prop you can pass a function as a component and also share props from parent itself" },
            { id: 4, title: "hello", desc: "By using render prop you can pass a function as a component and also share props from parent itself" },
            { id: 6, title: "hello", desc: "By using render prop you can pass a function as a component and also share props from parent itself" },
        ]
