...
import { selectArabic, selectClient, selectProject, selectUsers } from "../slices/infoSlice";
...
export default function Statistic() {
    ...
    const employeeTitle = arabic ? "الموظفين" : "Employee";
    const projectsTitle = arabic ? "المشاريع" : "Projects";
    const clientsTitle = arabic ? "العملاء" : "Clients";
