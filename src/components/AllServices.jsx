...
function AllServices({ image }) {
    ...
    <div className="container px-6 py-10 mx-auto">
        <h1 className={arabic ? "text-3xl text-right font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white" : "text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white"}>explore our Services</h1>
        ...
        <div className={arabic ? "mt-8 xl:mt-12 lg:flex md:flex md:flex-row-reverse lg:items-center" : "mt-8 xl:mt-12 lg:flex md:flex lg:items-center"}>
            <div className="grid w-full grid-cols-1 gap-8 lg:w-1/2 xl:gap-16 md:grid-cols-2">
                <div className={arabic ? "space-y-3 text-right" : "space-y-3 text-left"}>
                    ...
                    <h1 className="text-2xl font-semibold  text-gray-700 capitalize dark:text-white">Digital marketing</h1>
                ...
                <div className={arabic ? "space-y-3 text-right" : "space-y-3 text-left"}>
                    ...
                    <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Programming</h1>
                ...
                <div className={arabic ? "space-y-3 text-right" : "space-y-3 text-left"}>
                    ...
                    <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Motion graphic</h1>
                ...
                <div className={arabic ? "space-y-3 text-right" : "space-y-3 text-left"}>
                    ...
                    <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Branding</h1>
