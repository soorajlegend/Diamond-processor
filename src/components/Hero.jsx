        ...
        <>
            ...
            <div className='flex w-full h-screen justify-center items-center px-10 dark:bg-gray-900/100 ease-in-out'>
                ...
                <div className={arabic ? "md:absolute z-10 right-7 text-right sm:block  py-10 px-10 md:mt-10" : "md:absolute z-10 left-7 sm:block  py-10 px-10 md:mt-10"}>
                    <h1 className={arabic ? "md:text-7xl md:max-w-[70%] md:ml-[30%] font-bold border-l-emerald-300 text-gray-700 dark:text-gray-200 " : "md:text-7xl md:max-w-[50%] font-bold border-l-emerald-300 text-gray-700 dark:text-gray-200 "}>{idText}</h1>
                    <h2 className="md:text-3xl text-gray-600 dark:text-gray-300 animate-pulse">{ProcessorText}</h2>
                </div>
