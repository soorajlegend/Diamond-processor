...
function ContactForm() {
  ...
  return (
    ...
    <div className="container px-6 py-12 mx-auto">
        <div className={arabic ? "lg:flex md:flex-row-reverse lg:items-center lg:-mx-6" : "lg:flex lg:items-center lg:-mx-6"}>
            <div className={arabic ? "lg:w-1/2 lg:mx-6 text-right" : "lg:w-1/2 lg:mx-6 text-left"}>
                <h1 className={arabic ? "text-3xl text-right font-semibold text-gray-800 capitalize dark:text-white lg:text-5xl" : "text-3xl w-[70%] font-semibold text-gray-800 capitalize dark:text-white lg:text-5xl"}>
                    {title}
                </h1>

                <div className="mt-6 space-y-8 md:mt-8">
                    <p className={arabic ? "flex flex-row-reverse items-start -mx-2" : "flex items-start -mx-2"}>
                    ...
                    <p className={arabic ? "flex flex-row-reverse items-start -mx-2" : "flex items-start -mx-2"}>
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">+966540544246</span>
                    </p>
                    ...
                    <p className={arabic ? "flex flex-row-reverse items-start -mx-2" : "flex items-start -mx-2"}>
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">salem@idp.sa</span>
                    </p>
                </div>

                <div className={arabic ? "mt-6 md:mt-8 w-full text-right" :  "mt-6 md:mt-8 w-full text-left"}>
                    <h3 className="text-gray-600 dark:text-gray-300 ">{follow}</h3>

                    <div className={arabic ? "flex flex-row-reverse mt-4 -mx-1.5 " : "flex mt-4 -mx-1.5 "}>
                        <a className="mx-1.5 dark:hover:text-green-400 text-gray-400 transition-colors duration-300 transform hover:text-green-500" href="#">
