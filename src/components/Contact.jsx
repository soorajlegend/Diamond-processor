            ...
            <div className={arabic ? "arabic-text lg:w-1/2 lg:mx-6 text-right" : "lg:w-1/2 lg:mx-6 text-left"}>
                ...
                <div className={arabic ? "arabic-text mt-6 md:mt-8 w-full text-right" :  "mt-6 md:mt-8 w-full text-left"}>
                    ...
                    <div className={arabic ? "arabic-text flex flex-row-reverse mt-4 -mx-1.5 " : "flex mt-4 -mx-1.5 "}>
                        ...
                        <a className="mx-1.5 dark:hover:text-green-400 text-gray-400 transition-colors duration-300 transform hover:text-green-500" href={info.data.linkedIn}  target="_blank">
                        ...
                        <a className="mx-1.5 dark:hover:text-green-400 text-gray-400 transition-colors duration-300 transform hover:text-green-500" href={info.data.facebook}  target="_blank">
                            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7 10.2222V13.7778H9.66667V20H13.2222V13.7778H15.8889L16.7778 10.2222H13.2222V8.44444C13.2222 8.2087 13.3159 7.9826 13.4826 7.81591C13.6493 7.64921 13.8754 7.55556 14.1111 7.55556H16.7778V4H14.1111C12.9324 4 11.8019 4.46825 10.9684 5.30175C10.1349 6.13524 9.66667 7.2657 9.66667 8.44444V10.2222H7Z" fill="currentColor" />
                            </svg>
                        </a>

                        <a className="mx-1.5 dark:hover:text-green-400 text-gray-400 transition-colors duration-300 transform hover:text-green-500" href={info.data.instagram}  target="_blank">
                            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
