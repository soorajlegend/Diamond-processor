      ...
      <section className="max-w-screen-xl mx-auto my-10 bg-white dark:bg-gray-900">
        <div className="container  px-6 py-10 mx-auto">
          ...
          <div className="relative block w-full">
            <h1 className={arabic ? "text-3xl font-semibold mr-[50%] text-right text-gray-800 capitalize lg:text-4xl dark:text-white" : "text-3xl font-semibold ml-[50%] text-gray-800 capitalize lg:text-4xl dark:text-white"}>{ourConcept}</h1>
          ...
          <div className={arabic ? "mt-8 xl:mt-12 lg:flex flex flex-row lg:items-center" : "mt-8 xl:mt-12 lg:flex flex flex-row-reverse lg:items-center"}>

            <div className="grid w-full grid-cols-1 gap-8 lg:w-1/2 xl:gap-16 md:grid-cols-2">

              <div className={arabic ? "space-y-3 text-right" : "space-y-3"}>
